...
public class ELoginException extends EBusinessException{
	...
	public static final ELoginException LOGIN_USER_NOT_EXIST_ERROR = new ELoginException("10010005", "用户不存在");
	public static final ELoginException LOGIN_USER_BEEN_LOCKED = new ELoginException("10010006", "用户已被锁定");
}
