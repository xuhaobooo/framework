...
public class ResolvedMigrationImpl implements ResolvedMigration {
	...
	/**
	 * The name of the script to execute for this migration, relative to its
	 * classpath location.
	 */
	...
	/**
	 * @param script
	 *            The name of the script to execute for this migration, relative to
	 *            its classpath location.
	 */
	...
	public String toString() {
		return "ResolvedMigrationImpl{" + "version=" + version + ", description='" + description + '\'' + ", script='"
				+ script + '\'' + ", checksum=" + checksum + ", type=" + type + ", physicalLocation='"
				+ physicalLocation + '\'' + ", executor=" + executor + '}';
	}
