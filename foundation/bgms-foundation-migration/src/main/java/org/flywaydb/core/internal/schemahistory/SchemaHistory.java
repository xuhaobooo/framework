...
public abstract class SchemaHistory {
    ...
    public final void addBaselineMarker(MigrationVersion baselineVersion, String baselineDescription) {
        addAppliedMigration(null, baselineVersion, baselineDescription, MigrationType.BASELINE,
    ...
    protected final void doAddSchemasMarker(Schema[] schemas) {
        addAppliedMigration(null ,null, "<< Flyway Schema Creation >>",
     ...
     */
    public final void addAppliedMigration(String module, MigrationVersion version, String description, MigrationType type,
                                          String script, Integer checksum, int executionTime, boolean success) {
        doAddAppliedMigration(module, version, abbreviateDescription(description), type, abbreviateScript(script), checksum,
                executionTime, success);
    }

    protected abstract void doAddAppliedMigration(String module, MigrationVersion version, String description, MigrationType type,
                                                  String script, Integer checksum, int executionTime, boolean success);
