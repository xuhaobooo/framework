...
public class JdbcTableSchemaHistory extends SchemaHistory {
    ...
    @Override
	protected void doAddAppliedMigration(String module, MigrationVersion version, String description,
			MigrationType type, String script, Integer checksum, int executionTime, boolean success) {
        ...
        try {
            ...
            String moduleStr = module == null ? "public" : module;
            ...
            jdbcTemplate.update(database.getInsertStatement(table),
                    installedRank, moduleStr, versionStr, description, type.name(), script, checksum, installedBy,
